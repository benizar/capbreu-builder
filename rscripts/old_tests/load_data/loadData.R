##TODO: ADAPTAR - Una función que admita varios esquemas de propiedad y varios formatos (yml, json, etc)
##load.landSchema(filepath = x, format='yaml')
##if(x==*.yml)
##if(structure=='landholder-plot-neighbour')
