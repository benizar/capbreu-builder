...
rs_mountains        := $(rscripts_nodes_dir)/mountains.R
rs_rivers        := $(rscripts_nodes_dir)/rivers.R
...
csv_mountains        := $(patsubst $(rscripts_nodes_dir)/%.R,$(nodes_dir)/%.csv,$(rs_mountains))
csv_rivers        := $(patsubst $(rscripts_nodes_dir)/%.R,$(nodes_dir)/%.csv,$(rs_rivers))
